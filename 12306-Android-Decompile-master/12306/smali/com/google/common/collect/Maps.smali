...
.method public static difference(Ljava/util/Map;Ljava/util/Map;)Lcom/google/common/collect/MapDifference;
    ...
    invoke-static {v6, v10}, Lcom/google/common/base/Objects;->equal(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 335
    new-instance v11, Lcom/google/common/collect/Maps$ValueDifferenceImpl;

    invoke-direct {v11, v6, v10}, Lcom/google/common/collect/Maps$ValueDifferenceImpl;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method static entrySetImpl(Ljava/util/Map;Lcom/google/common/base/Supplier;)Ljava/util/Set;
    .locals 1
    .parameter
    .parameter
    .annotation system Ldalvik/annotation/Signature;
    ...
    new-instance v0, Lcom/google/common/collect/Maps$EntrySetImpl;

    invoke-direct {v0, p0, p1}, Lcom/google/common/collect/Maps$EntrySetImpl;-><init>(Ljava/util/Map;Lcom/google/common/base/Supplier;)V
...
.method static keySetImpl(Ljava/util/Map;)Ljava/util/Set;
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 1669
    .local p0, map:Ljava/util/Map;,"Ljava/util/Map<TK;TV;>;"
    new-instance v0, Lcom/google/common/collect/Maps$AbstractMapWrapper;

    invoke-direct {v0, p0}, Lcom/google/common/collect/Maps$AbstractMapWrapper;-><init>(Ljava/util/Map;)V

    invoke-virtual {v0}, Lcom/google/common/collect/Maps$AbstractMapWrapper;->keySet()Ljava/util/Set;
...
.method static valuesImpl(Ljava/util/Map;)Ljava/util/Collection;
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    invoke-virtual {v0}, Lcom/google/common/collect/Maps$AbstractMapWrapper;->values()Ljava/util/Collection;
