...
public abstract class BasicDeserializerFactory extends DeserializerFactory
{
    ...
    throws JsonMappingException
  {
    ...
    return new ArrayDeserializer(paramArrayType, localJsonDeserializer1, localTypeDeserializer);
  }
    ...
    throws JsonMappingException
  {
    ...
    return new CollectionDeserializer(localCollectionType2, localJsonDeserializer2, localTypeDeserializer, localConstructor);
  }
