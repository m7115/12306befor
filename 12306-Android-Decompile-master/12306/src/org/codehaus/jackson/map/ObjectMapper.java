  ...
  implements Versioned
{
  ...
  public void registerModule(Module paramModule)
  {
    ...
    paramModule.setupModule(new Module.SetupContext()
    {
      ...
      {
        jdField_this._deserializationConfig.appendAnnotationIntrospector(paramAnonymousAnnotationIntrospector);
        jdField_this._serializationConfig.appendAnnotationIntrospector(paramAnonymousAnnotationIntrospector);
      }
      ...
      {
        jdField_this._deserializationConfig.insertAnnotationIntrospector(paramAnonymousAnnotationIntrospector);
        jdField_this._serializationConfig.insertAnnotationIntrospector(paramAnonymousAnnotationIntrospector);
      }
