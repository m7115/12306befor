  ...
  implements f.a
{
  ...
  private String b()
  {
    ...
    while (true)
    {
      ...
      String str6 = s.D(this.d);
      if (!v.a(str6))
      {
        a.b("Scaned AP mac and name: " + str6);
        localHashMap.put("scan", str6);
      }
      String str7 = s.F(this.d);
      if (!v.a(str7))
        localHashMap.put("aaid", str7);
      a.b("广告请求参数:" + localHashMap.toString());
      return v.a(localHashMap);
      localHashMap.put("dma", v.a("d!j@d#g$r%s^j&h*", str1.toUpperCase()));
      break;
      label886: localHashMap.put("odin1", str2);
      break label429;
      label899: localHashMap.put("d[coord_status]", String.valueOf(s.e()));
    }
  }
