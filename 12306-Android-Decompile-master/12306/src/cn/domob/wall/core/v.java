...
public class v
{
  ...
  public static String b()
  {
    ...
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append(Integer.valueOf("010100".substring(0, 2))).append(".").append(Integer.valueOf("010100".substring(2, 4))).append(".").append(Integer.valueOf("010100".substring(4, 6)));
