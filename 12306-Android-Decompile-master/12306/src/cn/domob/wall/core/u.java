...
class u
{
  ...
  void a(Context paramContext, String paramString, final ImageView paramImageView, int paramInt)
  {
    b.b("Asynchronous request image resources url=" + paramString);
    final Drawable localDrawable = b(paramContext, paramString);
    if (localDrawable == null)
    {
    ...
    implements f.a
  {
    ...
    public void a(f paramf)
    {
      if (paramf.f() == 200)
      {
        final String str1 = paramf.a();
        u.b().b("Download finish:" + str1);
        final byte[] arrayOfByte = paramf.d();
        ...
        while (true)
        {
          try
          {
            ...
            ((Activity)this.a).runOnUiThread(new Runnable()
            {
              public void run()
              {
                BitmapDrawable localBitmapDrawable = u.this.a(arrayOfByte);
                if (localBitmapDrawable != null)
                {
                  u.a(u.this).put(str1, new SoftReference(localBitmapDrawable));
