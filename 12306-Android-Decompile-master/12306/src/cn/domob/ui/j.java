...
public class j
{
  ...
  public View a(final DetailsPageInfo paramDetailsPageInfo)
  {
    ...
    for (int i = h.g(this.b); ; i = h.f(this.b))
    {
      ...
      localRelativeLayout.findViewById(d.a(this.b, "dl01")).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          j.b().b("您点击了详情页下载按钮");
          j.a(j.this).onClickDetailsPageButton(paramDetailsPageInfo);
        }
      });
