...
public class DViewManager
{
  ...
  private void a(final DetailsPageInfo paramDetailsPageInfo)
  {
    ((Activity)this.e).runOnUiThread(new Runnable()
    {
      public void run()
      {
        DViewManager.c(DViewManager.this, new j(DViewManager.f(DViewManager.this), DViewManager.e(DViewManager.this)).a(paramDetailsPageInfo));
  ...
  private void a(final String paramString, final DService.ErrorCode paramErrorCode)
  {
    ((Activity)this.e).runOnUiThread(new Runnable()
    {
      public void run()
      {
        ...
        {
          DViewManager.a().e("错误码：" + paramErrorCode.toString() + "错误描述：" + paramString);
  ...
  private void a(final boolean paramBoolean)
  {
    ((Activity)this.e).runOnUiThread(new Runnable()
    {
      public void run()
      {
        DViewManager.b(DViewManager.this, DViewManager.i(DViewManager.this).a(paramBoolean, DViewManager.f(DViewManager.this), DViewManager.j(DViewManager.this), DViewManager.k(DViewManager.this), DViewManager.d(DViewManager.this), DViewManager.e(DViewManager.this)));
  ...
  public void addView(ViewGroup paramViewGroup1, ViewGroup paramViewGroup2)
  {
    ...
    {
      public void onShowDetailsPage(DetailsPageInfo paramAnonymousDetailsPageInfo)
      {
        DViewManager.a().b("打开广告详情页面");
        if (paramAnonymousDetailsPageInfo != null)
          DViewManager.a(DViewManager.this, paramAnonymousDetailsPageInfo);
      }
    });
    this.f.setReceiveDataListener(new DService.ReceiveDataListener()
    {
      public void onFailReceiveData(DService.ErrorCode paramAnonymousErrorCode, String paramAnonymousString)
      {
        ...
        DViewManager.a(DViewManager.this, paramAnonymousString, paramAnonymousErrorCode);
        if (DViewManager.c(DViewManager.this) != null)
          DViewManager.c(DViewManager.this).onFailReceiveData();
      }

      public void onSuccessReceiveData(List<AdInfo> paramAnonymousList1, List<AdInfo> paramAnonymousList2, ControlInfo paramAnonymousControlInfo)
      {
        DViewManager.this.c = true;
        DViewManager.a().b("获取到广告信息");
        DViewManager.a(DViewManager.this, (ArrayList)paramAnonymousList2);
        DViewManager.b(DViewManager.this, (ArrayList)paramAnonymousList1);
        DViewManager.a(DViewManager.this, paramAnonymousControlInfo);
        if (DViewManager.a(DViewManager.this) == null);
        while (true)
        {
