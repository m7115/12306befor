...
public final class InetAddresses
{
  ...
  {
    byte[] arrayOfByte = textToNumericFormatV4(paramString);
    if (arrayOfByte == null)
      arrayOfByte = textToNumericFormatV6(paramString);
    if (arrayOfByte == null)
    ...
    {
      throw new IllegalArgumentException(String.format("'%s' is extremely broken.", new Object[] { paramString }), localUnknownHostException);
    }
  }
    ...
    while (true)
    {
      try
      {
        ...
        if (j > 1)
        {
          ...
          {
            arrayOfString2 = arrayOfString1[1].split(":", 8);
            n = 0;
          }
        }
        else
