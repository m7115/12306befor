...
public final class Futures
{
    ...
    return new UninterruptibleFuture()
    {
        ...
        throws TimeoutException, ExecutionException
      {
        ...
        try
        {
          ...
          long l2 = paramAnonymousTimeUnit.toNanos(paramAnonymousLong);
          long l3 = l1 + l2;
          while (true)
            try
            {
  ...
  public static <I, O> Future<O> transform(Future<I> paramFuture, final Function<? super I, ? extends O> paramFunction)
  {
    if ((paramFuture instanceof ListenableFuture))
