...
public class WLGCMIntentService extends GCMBaseIntentService
{
  ...
  private BroadcastReceiver resultReceiver = new BroadcastReceiver()
  {
    public void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
    {
      if ((getResultCode() == 1) || (!WLDroidGap.isForeGround()))
        WLGCMIntentService.this.onUnhandled(paramAnonymousContext, paramAnonymousIntent);
    }
  };
    ...
    implements Parcelable
  {
    ...
    {
      public WLGCMIntentService.Message createFromParcel(Parcel paramAnonymousParcel)
      {
        return new WLGCMIntentService.Message(paramAnonymousParcel, null);
      }

      public WLGCMIntentService.Message[] newArray(int paramAnonymousInt)
      {
        return new WLGCMIntentService.Message[paramAnonymousInt];
      }
    };
