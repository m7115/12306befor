...
public class WLOptionsMenu
{
  ...
  private WLMenuItem getItemByJavaScriptId(String paramString)
  {
    ...
    do
    {
      ...
      if (!bool)
        break;
      localWLMenuItem = (WLMenuItem)localIterator.next();
    }
    while (!localWLMenuItem.getJavaScriptId().equals(paramString));
    Object localObject = localWLMenuItem;
    return localObject;
  }
  ...
  public List<WLMenuItem> getItems()
  {
    ...
    {
      public int compare(WLMenuItem paramAnonymousWLMenuItem1, WLMenuItem paramAnonymousWLMenuItem2)
      {
        return paramAnonymousWLMenuItem1.getId() - paramAnonymousWLMenuItem2.getId();
      }
    });
