  ...
  implements WLDroidGapListener
{
  ...
  public class PrepackagedAssetsManager
  {
    ...
    private void handleNotEnoughSpace(final Long paramLong, long paramLong1)
    {
      ...
      WLDroidGap.this.runOnUiThread(new Runnable()
      {
        public void run()
        {
          WLUtils.showDialog(WLDroidGap.this, "Error", "Application installation failed because there is insufficient storage space available. Free " + localDecimalFormat.format(paramLong.longValue() / 1048576.0D) + " MB and try again.", "Exit", new DialogInterface.OnClickListener()
          {
